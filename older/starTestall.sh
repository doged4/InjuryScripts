...
for i in $(ls *R2_001.fastq.gz | rev | cut -c 17- | rev | uniq);  do\
	 ...
	 ls /injury/MegaFolderB/deepReads/200612_K00153_0841_AHNKTMBBXX_PE100_1/FMRB01/FASTQ/${i}_R2_001.fastq.gz 
       ...
       /STAR/bin/Linux_x86_64/STAR --runMode alignReads --runThreadN 50 --genomeDir /genome/genomes/Ensembl_Grch38/STAR.Ensembl.GRCh38   --readFilesIn  ./${i}_R1_001.fastq.gz   ./${i}_R2_001.fastq.gz   --outFileNamePrefix  ./STAR.Ensembl.Out/${i}/  --sjdbGTFfile /genome/genomes/Ensembl_Grch38/Homo_sapiens.GRCh38.100.gtf --outSAMtype SAM --readFilesCommand zcat;
	cd ..; cd ..;	
